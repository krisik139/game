...
folder_img = pygame.image.load("images/folder.png")
folder_img = pygame.transform.scale(folder_img, (TILE_SIZE, TILE_SIZE))
...
while running:
    ...
    hint_surface = font.render(f"КІЛЬКІСТЬ КЕШУ: {CASH}", True, (0,0,0))
